...
export const TOPICS = [
  ...
  { id: 'INTEGRALS', label: 'Nguyên hàm & Tích phân' },
  { id: 'FUNCTIONS', label: 'Khảo sát hàm số' },
  { id: 'LIMITS', label: 'Giới hạn – Liên tục' },
...
export const TOPIC_CONFIG = [
  ...
  { key: 'INTEGRALS', label: 'Nguyên hàm & Tích phân', color: 'blue', mockAcc: 75 },
  { key: 'FUNCTIONS', label: 'Khảo sát hàm số', color: 'orange', mockAcc: 62 },
  ...
  { key: 'LIMITS', label: 'Giới hạn – LT', color: 'purple', mockAcc: 65 },
